...
import {updateSRSTableContent,addSRSTableContent} from "services/srs.service"
...
const SrsDocContentDialogComponent = ({ open, onClose, qaqtDocData, type, fetchData, editData }) => {
...
const handleDialogConfirm = async (formValues) => {
  ...
  if (isEditMode) {
    ...
    result = await updateSRSTableContent(dto);
  } else {
    ...
    result = await addSRSTableContent(dtoArray);
  }
...
export default SrsDocContentDialogComponent;

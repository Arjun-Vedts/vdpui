...
import { forwardSRSDocxRecord } from "services/srs.service";


const SRSForwardComponent = ({ open, onClose, projectId, loginId, rowData }) => {
 ...
 //console.log("fwrdby--",values.forwardBy)
  ...
  try {
   ...
   // console.log("payload",payload);
    ...
    const res = await forwardSRSDocxRecord(payload); // 🔹 your API function
    ...
    if (res) {
      Swal.fire({
        icon: "success",
        title: "Success",
        text: "SRS Docx forwarded successfully",
        ...
        >
          <div className="modal-content modal-content-custom">
            <div className="modal-header bg-secondary text-white d-flex justify-content-between">
              <h5 className="modal-title">SRS Document Forward</h5>
              <button
                type="button"
...
export default SRSForwardComponent;

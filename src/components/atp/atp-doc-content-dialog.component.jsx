...
import { addAtpTableContent, updateAtpTableContent } from "services/atp.service";
...
const AtpDocContentDialogComponent = ({ open, onClose, qaqtDocData, type, fetchData, editData }) => {
...
const handleDialogConfirm = async (formValues) => {
  ...
  if (isEditMode) {
    ...
    result = await updateAtpTableContent(dto);
  } else {
    ...
    result = await addAtpTableContent(dtoArray);
  }
...
export default AtpDocContentDialogComponent;

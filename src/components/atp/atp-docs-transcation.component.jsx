...
import './atp-docs-tran.css';
import { format } from 'date-fns';

const ATPDocsTransactionComponent = () => {
  ...
  return (
          <Box className="mainRow">
            <Helmet>
                <title> SRS Doc Transaction</title>
            </Helmet>
            <Navbar />
            <Box id="main-container" className="main-container"><br />
               <Box id="card-title" ><Grid container spacing={2}>
                <Grid item xs={11} ><Typography variant="h6" component="h6" className="card-title-typography">ATP Doc Transaction</Typography></Grid>
...
export default ATPDocsTransactionComponent;
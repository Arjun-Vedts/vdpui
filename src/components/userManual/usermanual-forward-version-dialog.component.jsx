...
import { forwardUserManual } from "services/usermanual.service";
import AlertConfirmation from "common/AlertConfirmation.component";


const UserManualForwardComponent = ({ open, onClose, projectId, loginId, rowData }) => {
 ...
 //console.log("fwrdby--",values.forwardBy)
  ...
  try {
   ...
   // console.log("payload",payload);
    ...
    const res = await forwardUserManual(payload); // 🔹 your API function
    ...
    if (res) {
      Swal.fire({
        icon: "success",
        title: "Success",
        text: "User Manual forwarded successfully",
        ...
        >
          <div className="modal-content modal-content-custom">
            <div className="modal-header bg-secondary text-white d-flex justify-content-between">
              <h5 className="modal-title">User Manual Forward</h5>
              <button
                type="button"
...
export default UserManualForwardComponent;
